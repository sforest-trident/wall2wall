<?php
    $data = array(
        'heading' => 'Wall2Wall Plastering',
        'subheading' => 'Get In Touch',
        'button' => 'Contact',
        'button_link' => '#'
    );

    // php: _promoblock(heading="Wall2Wall Plastering" subheading="Get In Touch" button="Contact" button_link="#")
    // shortcode: [section-promoblock heading="Wall2Wall Plastering" subheading="Get In Touch" button="Contact" button_link="#"]
?>
